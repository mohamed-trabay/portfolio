...
const allInImages = [
  "assets/allinstyle/all1.webp",
  "assets/allinstyle/pic2.webp",
  "assets/allinstyle/pic3.webp",
  "assets/allinstyle/pic4.webp",



];
let currentallInIndex = 0;
    ...
    <div style="display: flex; gap: 10px; margin: 15px 0; flex-wrap: wrap;">
        <a href="https://play.google.com/store/apps/details?id=com.zbooma.suhbah" target="_blank" style="display: inline-flex; align-items: center; gap: 8px; padding: 10px 20px; background: #000; color: #fff; text-decoration: none; border-radius: 8px; font-size: 14px; transition: background 0.3s;">
            ...
            Get it on Google Play
               ...
               <a href="https://apps.apple.com/eg/app/suhbah/id6755391307" target="_blank" style="display: inline-flex; align-items: center; gap: 8px; padding: 10px 20px; background: #000; color: #fff; text-decoration: none; border-radius: 8px; font-size: 14px; transition: background 0.3s;">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
...
function showallInModal(index = 0) {
  imgModalImages.style.display = "none";
  imgModalImg.style.display = "block";
  imgModalPrev.style.display = "block";
  imgModalNext.style.display = "block";
  currentallInIndex = index;

  imgModalImg.src = allInImages[currentallInIndex];
  imgModalImg.alt = "allIn" + (currentallInIndex + 1);
  imgModalImg.style.width = window.innerWidth < 700 ? "90vw" : "420px";
  imgModalImg.style.height = window.innerWidth < 700 ? "auto" : "420px";
  imgModalImg.style.objectFit = "contain";
  imgModalImg.style.borderRadius = "16px";
  ...
  imgModalText.innerHTML = `
        <strong>All In Style App</strong><br>
A Flutter e-commerce application converted from a WordPress fashion store, allowing users to browse clothing, accessories, and shoes with a smooth and modern shopping experience.<br><br>
     <div style="display: flex; gap: 10px; margin: 15px 0; flex-wrap: wrap;">
        <a href="https://play.google.com/store/apps/details?id=com.zbooma.allinstyle" target="_blank" style="display: inline-flex; align-items: center; gap: 8px; padding: 10px 20px; background: #000; color: #fff; text-decoration: none; border-radius: 8px; font-size: 14px; transition: background 0.3s;">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                <path d="M3,20.5V3.5C3,2.91 3.34,2.39 3.84,2.15L13.69,12L3.84,21.85C3.34,21.6 3,21.09 3,20.5M16.81,15.12L6.05,21.34L14.54,12.85L16.81,15.12M20.16,10.81C20.5,11.08 20.75,11.5 20.75,12C20.75,12.5 20.5,12.92 20.16,13.19L17.89,14.5L15.39,12L17.89,9.5L20.16,10.81M6.05,2.66L16.81,8.88L14.54,11.15L6.05,2.66Z"/>
            </svg>
            Get it on Google Play
        </a>
               <a href="https://apps.apple.com/eg/app/all-in-style/id6752820748" target="_blank" style="display: inline-flex; align-items: center; gap: 8px; padding: 10px 20px; background: #000; color: #fff; text-decoration: none; border-radius: 8px; font-size: 14px; transition: background 0.3s;">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.71,19.5C17.88,20.74 17,21.95 15.66,21.97C14.32,22 13.89,21.18 12.37,21.18C10.84,21.18 10.37,21.95 9.1,22C7.79,22.05 6.8,20.68 5.96,19.47C4.25,17 2.94,12.45 4.7,9.39C5.57,7.87 7.13,6.91 8.82,6.88C10.1,6.86 11.32,7.75 12.11,7.75C12.89,7.75 14.37,6.68 15.92,6.84C16.57,6.87 18.39,7.1 19.56,8.82C19.47,8.88 17.39,10.1 17.41,12.63C17.44,15.65 20.06,16.66 20.09,16.67C20.06,16.74 19.67,18.11 18.71,19.5M13,3.5C13.73,2.67 14.94,2.04 15.94,2C16.07,3.17 15.6,4.35 14.9,5.19C14.21,6.04 13.07,6.7 11.95,6.61C11.8,5.46 12.36,4.26 13,3.5Z"/>
            </svg>
            Download on App Store
...
- Browse women's, men's, and kids' fashion with category filtering<br>
- Add products to favorites and manage your cart<br>
- Secure in-app payment via Paymob integration<br>
- User profile management with order history<br>
- Dark/Light theme support and Arabic/English localization<br><br>
    <strong>Technologies Used:</strong><br>
   - Flutter · Dart · Paymob · REST API · Bloc/Cubit · Clean Architecture · Responsive UI · Localization
...
imgModalPrev.onclick = function (e) {
  ...
  else if (imgModalImg.alt.startsWith("allIn")) {
    currentallInIndex =
      (currentallInIndex - 1 + allInImages.length) % allInImages.length;
    highlightallInImage();
...
imgModalNext.onclick = function (e) {
  ...
  if (imgModalImg.alt.startsWith("Smart Home")) {
    ...
    currentallInIndex = (currentallInIndex + 1) % allInImages.length;
    highlightallInImage();
  }
};
